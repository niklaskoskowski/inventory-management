...
import {
  ...
  formatDateTime, formatMoney, toDateInput, isOverdue,
} from '../lib/format.js';
...
export default {
  ...
  setup(props, { emit }) {
    ...
    return {
      ...
      asset, isNew, isSet, lines, outUnits, history, members, warrantyExpired,
      ...
      STATUSES, CONDITIONS, CONDITION_LABEL, statusLabel,
      formatDateTime, formatMoney, isOverdue,
      ...
      <form v-show="tab === 'details'" @submit.prevent="save">
        <div class="row g-3">
          ...
          <div class="col-6" v-if="!isSet">
            ...
            <div v-if="asset" class="form-text small">
